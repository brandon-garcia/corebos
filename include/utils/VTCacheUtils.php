...
class VTCacheUtils {
	...
	public static function updateFieldInfo($tabid, $fieldname, $fieldid, $fieldlabel,
	...
	public static function updateReport_Info($userid, $reportid, $primarymodule, $secondarymodules, $reporttype,
