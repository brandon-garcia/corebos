...
<table border=0 cellspacing=0 cellpadding=5 width=95% align=center>
	<tr>
		...
		<tr>
			...
			<br /><br /><div id="google_sync_verifying" style="display:none;"><img src="themes/images/vtbusy.gif" align="absmiddle"><?php echo $mod_strings["LBL_GOOGLE_SYNC_CONTROL_ACCESS_DATA"]; ?></div><div id="google_sync_text">
			<?php
